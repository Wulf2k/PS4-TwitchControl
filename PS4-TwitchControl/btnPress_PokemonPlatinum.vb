...
Partial Public Class frmPS4Twitch
    ...
    Private Sub btnPress_PokemonPlatinum()
        ...
        SyncLock queuelock
            ...
            Select Case QueuedInput(0).cmd
                ...
                Case "reconnect1"
                    ...
                    ProcessProperties.Arguments = $"""c:\emus\DS\Roms\3541 - Pokemon Platinum Version (US)(XenoPhobia).nds"""
    ...
    Private Sub execCMD_PokemonPlatinum(user As String, role As String, cmd As String)
    ...
    Private Sub ProcessCMD_PokemonPlatinum(user As String, role As String, cmd As String)
        Dim tmpuser = user
        Dim tmpcmd = cmd
