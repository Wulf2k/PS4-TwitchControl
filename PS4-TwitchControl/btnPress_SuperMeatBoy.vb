    ...
    Private Sub execCMD_SuperMeatBoy(user As String, role As String, cmd As String)
        ...
        Select Case cmd
            ...
            Case "flywrench"
                ...
                ProcessCMD(user, role, $"nh,h-2,hb-2,h-10,start,ddx2,h-15,a,h-45,a,h-150,a-130,dlx8,a-{duration},")
                Return
            Case "naija"
                If duration = 0 Then duration = 100
                ProcessCMD(user, role, $"nh,h-2,hb-2,h-10,start,ddx2,h-15,a,h-45,a,h-150,a-130,dlx4,a-{duration},")
                Return
            Case "ogmo"
                If duration = 0 Then duration = 100
            ...
            Case "zapl"
                ProcessCMD(user, role, $"ha,hx,wl-1,nh-{duration},")
                Return
            Case "zapr"
                ProcessCMD(user, role, $"ha,hx,wr-1,nh-{duration},")
                Return
