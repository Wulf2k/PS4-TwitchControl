...
Partial Public Class frmPS4Twitch
    Private Function btnPress_Pikuniku()
        ...
        Return 0
    End Function
    Private Sub execCMD_Pikuniku(user As String, role As String, cmd As String)
        Dim buttons = 0
        ...
        If ((cmd(0) = "w") Or (cmd(0) = "l") Or (cmd(0) = "a") Or (cmd(0) = "j")) Or    'If ((cmd(0) = "w") Or (cmd(0) = "l") Or (cmd(0) = "a")) Or
