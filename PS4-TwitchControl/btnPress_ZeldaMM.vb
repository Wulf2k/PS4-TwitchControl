...
Partial Public Class frmPS4Twitch
    ...
    Private Sub execCMD_ZeldaMM(user As String, role As String, cmd As String)
    ...
    Private Sub ProcessCMD_ZeldaMM(user As String, role As String, cmd As String)
        Dim tmpuser = user
        Dim tmpcmd = cmd
